<template>
    <!-- <footer class="bg-white lg:grid lg:grid-cols-5 mt-16">
      <div class="relative block h-32 lg:col-span-2 lg:h-full ">
        <img
          src="../../../public/assets/img/497076.jpg"
          alt=""
          class="absolute inset-0 h-full w-full object-cover lg:p-8 sm:rounded-none lg:rounded-full border-t-8 border-white lg:border-none"
        />
      </div>
      ...
      <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            <p>
              <span class="text-xs uppercase tracking-wide text-gray-500"> Call Me </span>
    
              <a href="#" class="block text-2xl font-medium text-gray-900 hover:opacity-75 sm:text-3xl border-t-4 border-t-gray-500">
                0123456789
              </a>
            </p>
  ...
  <nav>
    ...
    <div class="grid grid-flow-col gap-4">
      <a href="#"
                  rel="noreferrer"
                  target="_blank"
                  class="text-orange-700 transition hover:opacity-75"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-current"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"></path></svg></a>
